...
public class UserConverter  implements Converter<User, UserDTO> {
	...
	public UserDTO toDTO(User user) {
		UserDTO userDTO = new UserDTO(user.getId(), user.getUsername(), user.getPassword(), user.getUsertype(),user.getBarcode(), user.getScode());
		return userDTO;
	}
	...
	public User toEntity(UserDTO userDTO) {
		User user = new User(userDTO.getId(), userDTO.getUsername(), userDTO.getPassword(), userDTO.getUsertype(), userDTO.getBarcode(), userDTO.getScode());
		return user;
	}
