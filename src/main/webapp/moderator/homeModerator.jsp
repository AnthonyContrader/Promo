	...
	<div class="row" style="height: 100%;">
	 	<div class="col-3 p-3" style="background-color: #C1272D;">
			...
			<ul class="list-group mt-3">
				<li class="list-group-item"><a href="/Moderator/viewAllClients/">Clients</a></li>
				<li class="list-group-item"><a href="/Moderator/viewAllScreens/">Screens</a></li>
				<li class="list-group-item"><a href="/Moderator/viewAllShops/">Shops</a></li>
			</ul>
