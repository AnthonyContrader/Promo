...
describe('Message e2e test', () => {
    ...
    it('should load Messages', async () => {
        ...
        expect(await messageComponentsPage.getTitle()).toMatch(/gatewayApp.micro2Message.home.title/);
    });
    ...
    it('should load create Message page', async () => {
        ...
        expect(await messageUpdatePage.getPageTitle()).toMatch(/gatewayApp.micro2Message.home.createOrEditLabel/);
