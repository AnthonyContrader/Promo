...
import { DeviceDeleteDialogComponent } from 'app/entities/micro1/device/device-delete-dialog.component';
import { DeviceService } from 'app/entities/micro1/device/device.service';
